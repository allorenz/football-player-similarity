...
def load_shooting():
       # goalkeeper and field players
       data = pd.read_csv("../data/fbref/raw/shooting.csv")
       data = data[data["Season"] == "2022-2023"]
       ...
       'Unnamed: 22_level_0_Matches','90s']
...
def load_goalkeeping():
       data = pd.read_csv("../data/fbref/raw/goalkeeping.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_advanced_goalkeeping():
       # goalkeeper only
       data = pd.read_csv("../data/fbref/raw/advanced_goalkeeping.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_defensive_actions():
       # goalkeeper and field players
       data = pd.read_csv("../data/fbref/raw/defensive_actions.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_goal_shot_creation():
       data = pd.read_csv("../data/fbref/raw/goal_and_shot_creation.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_miscellaneous_stats():
       data = pd.read_csv("../data/fbref/raw/miscellaneous_stats.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_passing():
       # goalkeeper and field players
       data = pd.read_csv("../data/fbref/raw/passing.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_playing_time():
       data = pd.read_csv("../data/fbref/raw/playing_time.csv")
       data = data[data["Season"] == "2022-2023"]
...
def load_possession():
       data = pd.read_csv("../data/fbref/raw/possession.csv")
       data = data[data["Season"] == "2022-2023"]
