...
target = X.loc[[225375]].values.tolist()
print(target)
print("Queried Player")
name_of_target = df_player.loc[[225375], 'Name'].values[0]
...
# create cluster
kmeans = KMeans(n_clusters=len(X.columns), random_state=42, n_init="auto").fit(X)
